...
![Topologia da Rede](imagens/01-topologia-completa.png)
...
![VLANs da Matriz](imagens/02-vlans-matriz.png)

### VLANs da Filial

![VLANs da Filial](imagens/03-vlans-filial.png)
...
![DHCP PC Admin](imagens/04-dhcp-pc-admin.png)

### DHCP na Filial

![DHCP PC Visitante Filial](imagens/05-dhcp-pc-visitante-filial.png)
...
![DNS e Web Interno](imagens/06-dns-web-empresa-local.png)
...
![Visitante Bloqueado pela ACL](imagens/07-acl-visitante-matriz-bloqueado.png)

### Administração com Acesso Permitido

![Admin Acessa Servidor](imagens/08-admin-acessa-servidor.png)
...
![SSH TI Permitido](imagens/09-ssh-ti-acesso-permitido.png)

### SSH Bloqueado para Visitantes

![SSH Visitante Bloqueado](imagens/10-ssh-visitante-bloqueado.png)
...
![Internet Simulada](imagens/11-internet-simulada.png)

### Tradução NAT/PAT

![NAT Translations](imagens/12-nat-translations.png)
